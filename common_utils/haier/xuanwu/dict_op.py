...
def add_word_dict_in_xuanwu(dict_code, dict_name, parent_code=0, dict_type="ENUM", dict_category="OTHER"):
    """
    向玄武系统中新增字典
    :param dict_code: 玄武字典代码
    ...
    "Origin": "https://aidev.haiersmarthomes.com",
    "Pragma": "no-cache",
    "Referer": "https://aidev.haiersmarthomes.com/xuanwu-admin/nlp/dictionary/add",
...
def main():
    # add word dict
    res_info = add_word_dict_in_xuanwu(dict_code="english_song", dict_name="英文歌名称")
    print(res_info)
